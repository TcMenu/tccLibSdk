...
const char* const enumStrCars[]  = { enumStrCars_0, enumStrCars_1, enumStrCars_2, enumStrCars_3, enumStrCars_4 };
const AnyMenuInfo minfoCars = { "Cars", 18, 0xffff, 0, NO_CALLBACK };
ListRuntimeMenuItem menuCars(&minfoCars, 5, enumStrCars, ListRuntimeMenuItem::FLASH_ARRAY, nullptr, INFO_LOCATION_PGM);
...
const char* const enumStrFoods[]  = { enumStrFoods_0, enumStrFoods_1, enumStrFoods_2, enumStrFoods_3 };
const EnumMenuInfo minfoFoods = { "Foods", 15, 0xffff, 3, NO_CALLBACK, enumStrFoods };
...
const AnyMenuInfo minfoTime = { TC_I18N_MENU_6_NAME, 6, 0xffff, 0, NO_CALLBACK };
TimeFormattedMenuItem menuTime(&minfoTime, TimeStorage(0, 0, 0, 0), (MultiEditWireType)3, &menuRGB, INFO_LOCATION_PGM);
const AnyMenuInfo minfoText = { TC_I18N_MENU_5_NAME, 5, 0xffff, 0, NO_CALLBACK };
...
const AnyMenuInfo minfoLarge = { TC_I18N_MENU_3_NAME, 3, 0xffff, 0, NO_CALLBACK };
EditableLargeNumberMenuItem menuLarge(&minfoLarge, LargeFixedNumber(9, 3, 0U, 0U, false), true, &menuRuntimeItems, INFO_LOCATION_PGM);
...
const AnalogMenuInfo minfoAnalog = { TC_I18N_MENU_1_NAME, 1, 0xffff, 255, NO_CALLBACK, 0, 1, TC_I18N_MENU_1_UNIT };
...
void setupMenu() {
    ...
    gfx = new AdafruitSSD1306I2c(defaultWireTypePtr, 0xFF, 0xFF, 64, 128, ENCMODE_UTF8, SSD_1306);
    gfx->setRotation(0);
    gfx->begin();
    renderer.setUpdatesPerSecond(5);
    gfxDrawable.setGraphics(gfx);
    gfxDrawable.setFontHandler(gfx->getFontHandler());
    keyboardLayout.setRowPin(0, 16);
    keyboardLayout.setRowPin(1, 17);
    keyboardLayout.setRowPin(2, 18);
    keyboardLayout.setRowPin(3, 19);
    keyboardLayout.setColPin(0, 20);
    keyboardLayout.setColPin(1, 21);
    keyboardLayout.setColPin(2, 22);
