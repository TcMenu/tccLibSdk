...
EditableLargeNumberMenuItem menuLarge(&minfoLarge, LargeFixedNumber(9, 3, 0U, 0U, false), true, nullptr, INFO_LOCATION_PGM);
const AnyMenuInfo minfoRGB = { "RGB", 7, 0xffff, 0, NO_CALLBACK };
Rgb32MenuItem menuRGB(&minfoRGB, RgbColor32(0, 0, 0), false, &menuLarge, INFO_LOCATION_PGM);
...
FloatMenuItem menuFloat(&minfoFloat, 0.0, &menuMute, INFO_LOCATION_PGM);
